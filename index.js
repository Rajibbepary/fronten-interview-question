...
// const carobject = cars.map((car, index) =>{
//     return {
//         car,
//         index
//     }
...
// const html = cars.map (car => `<li>${car}</li>`);
// console.log(html.join(' '));
//console.log(carobject.join );

 //let text = ' ';
//let i = 0;

//et len = cars.length; break()
...
//Today my topic discuse what is a javaScript string method
